...
export const Theme = ({setTheme}) => (
  <div className={classes.Theme}>
    <input type="checkbox" defaultChecked='false' className={classes.Switch} onClick={setTheme} />
    <svg className={classes.Checkbox} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 80">
      <path
